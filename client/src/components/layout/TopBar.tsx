...
export default function TopBar() {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 h-[52px] bg-[#1c1d1f] border-b border-[#36373a] flex items-center px-4 text-jira-text z-50">
            <div className="w-[180px] flex items-center gap-3 shrink-0">
                <PanelLeft size={18} className="text-[#a9abad]" />
            ...
            <div className="flex-1 flex items-center justify-center gap-2 min-w-0">
                ...
                <button className="flex items-center gap-1.5 bg-[#6f9deb] text-[#101214] text-sm font-semibold px-4 h-8 rounded-md hover:bg-[#87adf0] whitespace-nowrap">
                    <Plus size={18} />Create
                </button>
            </div>
