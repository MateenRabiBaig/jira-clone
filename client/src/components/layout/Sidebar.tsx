    ...
    return (
        <aside className={`fixed left-0 top-[68px] bottom-0 z-40 bg-[#1c1d1f] border-r border-[#36373a] text-white transition-all duration-300 ${collapsed ? "w-20" : "w-[232px]"}`}>
            <nav className="h-full overflow-y-auto py-4">
                ...
                <div className="mt-6 px-4 flex items-center justify-between text-[12px] uppercase tracking-wider text-[#85878a]"><span>Navigation</span><Search size={15} /></div>
                ...
                <div className="mt-8 mx-4 border-t border-[#36373a] pt-4 text-[#85878a] text-xs">Recommended</div>
                <div className="mx-4 mt-3 bg-[#242528] p-4 text-[#d7d9db]"><div className="text-sm font-semibold">Unlock your AI teammate</div><p className="text-xs text-[#96999e] mt-2 leading-5">Rovo connects your tools and knowledge so work gets done for you.</p><span className="block text-[#75a4f7] text-xs mt-3">Try Rovo now</span></div>
            </nav>
        </aside>
    );
}
